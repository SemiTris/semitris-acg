...
本文档包只包含范围、需求、设计、计划与验收标准，**不包含任何 Java / Vue 代码实现**。所有代码由实现方（Claude Code 或 owner）按文档编写，以巩固 Spring Boot + MyBatis + Vue 的学习成果。
